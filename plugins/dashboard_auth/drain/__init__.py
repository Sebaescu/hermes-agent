...
# Shared fail-closed entropy gate — centralised so every bearer-secret
# provider applies the same bar. Re-exported here so existing callers/tests
# that reference ``drain.assess_secret_strength`` keep resolving.
